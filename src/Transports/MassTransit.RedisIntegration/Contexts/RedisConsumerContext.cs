namespace MassTransit.RedisIntegration.Contexts
{
    ...
    public class RedisConsumerContext<TKey, TValue> :
        BasePipeContext,
        ...
        where TValue : class
    {
        ...
        public RedisConsumerContext(IHostConfiguration hostConfiguration, ReceiveSettings receiveSettings, IHeadersDeserializer headersDeserializer,
        ...
        {
            _consumer.Subscribe(ReceiveSettings.Stream);
