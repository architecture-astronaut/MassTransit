namespace MassTransit.RedisIntegration.Contexts
{
    ...
    public class RedisConsumeContext<TKey, TValue> :
        ...
        where TValue : class
    {
        ...
        public RedisConsumeContext(ReceiveContext receiveContext, ConsumeResult<TKey, TValue> result)
            : base(receiveContext)
        {
            Message = result.Message.Value;
            _adapter = new RedisHeaderAdapter<TKey, TValue>(result, receiveContext);
        }
