namespace MassTransit.RedisIntegration
{
    ...
    public interface IRedisFetchConfigurator
    {
        /// <summary>
        ...
        /// <summary>
        /// Initial maximum number of bytes per Stream+partition to request when fetching messages from the broker. If the client encounters a message larger than this value it will
        ...
        /// size accepted by the broker is defined via `message.max.bytes` (broker config) or `max.message.bytes` (broker Stream config). `fetch.max.bytes` is automatically adjusted
        ...
        /// <summary>
        /// How long to postpone the next fetch request for a Stream+partition in case of a fetch error.
        /// default: 500
        /// importance: medium
        /// </summary>
