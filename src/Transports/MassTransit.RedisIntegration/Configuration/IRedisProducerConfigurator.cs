namespace MassTransit.RedisIntegration
{
    ...
    public interface IRedisProducerConfigurator
    {
        /// <summary>
        ...
        /// <summary>
        /// compression codec to use for compressing message sets. This is the default value for all Streams, may be overridden by the Stream configuration property
        /// `compression.codec`.
        /// default: none
        /// importance: medium
        /// </summary>
        ...
        /// <summary>
        /// Maximum total message size sum allowed on the producer queue. This queue is shared by all Streams and partitions. This property has higher priority than
        ...
        /// <summary>
        /// Maximum number of messages allowed on the producer queue. This queue is shared by all Streams and partitions.
        /// default: 100000
        /// importance: high
        /// </summary>
        ...
        /// is the maximum time
        /// librdRedis may use to deliver a message (including retries). Delivery error occurs when either the retry count or the message timeout are exceeded. The message
        /// timeout is
    ...
    public interface IRedisProducerConfigurator<TKey, TValue> :
        IRedisProducerConfigurator
    {
