namespace MassTransit.RedisIntegration
{
    ...
    public interface IRedisStreamReceiveEndpointConfigurator :
        IReceiveEndpointConfigurator
    {
        ...
        /// <summary>
        /// Maximum allowed time between calls to consume messages (e.g., rd_Redis_consumer_poll()) for high-level consumers. If this interval is exceeded the consumer is considered
        ...
        /// <summary>
        /// Minimum number of messages per Stream+partition librdRedis tries to maintain in the local consumer queue.
        /// default: 100000
        /// importance: medium
        /// </summary>
        ...
        /// <summary>
        /// Maximum number of kilobytes per Stream+partition in the local consumer queue. This value may be overshot by fetch.message.max.bytes. This property has higher priority than
        /// queued.min.messages.
        /// default: 1048576
        /// importance: medium
        /// </summary>
        ...
        /// <summary>
        /// Emit RD_Redis_RESP_ERR__PARTITION_EOF event whenever the consumer reaches the end of a partition.
        /// default: false
        /// importance: low
        /// </summary>
        ...
        void ConfigureFetch(Action<IRedisFetchConfigurator> configure);
        ...
        /// <summary>
        /// Create Stream if not exists every time endpoint starts (admin permissions are required).
        /// </summary>
        /// <param name="configure"></param>
        void CreateIfMissing(Action<RedisStreamOptions> configure);
    }


    public interface IRedisStreamReceiveEndpointConfigurator<TKey, TValue> :
        IRedisStreamReceiveEndpointConfigurator
        where TValue : class
    {
